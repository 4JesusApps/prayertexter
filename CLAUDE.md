...
**YOU ARE IN: `prayertexter/polecats/chrome/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/prayertexter/` (rig root) or other directories
...
**Your mail address:** `prayertexter/polecats/chrome`
**Your rig:** prayertexter
**Your Witness:** `prayertexter/witness`
...
| Ask Witness for help | `gt mail send prayertexter/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`prayertexter/witness`) when:
...
```bash
gt mail send prayertexter/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
