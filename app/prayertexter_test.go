	...
	for _, test := range testCases {
		...
		t.Run(test.description, func(t *testing.T) {
			...
			if test.expectedError {
				...
				if len(ddbMock.PutItemInputs) == 5 {
					input := ddbMock.PutItemInputs[3]
